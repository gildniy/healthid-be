OUTLET_SUCCESS_RESPONSES = {
    ...
    "activated_user_in_outlet": "User activated successfully in outlet",
    "outlet_now_default": "User default outlet changed successfully",
    "deactivated_user_in_outlet": "User deactivated successfully from outlet"
...
OUTLET_ERROR_RESPONSES = {
    ...
    "outlet_exists": "This business already has an outlet with same name",
    "tax_number_exists": "There is an outlet with same tax number",
    "invalid_outlet_name": "Entered outlet name is not valid",
}
